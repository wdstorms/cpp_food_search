...
class PacmanGraph {
    private:
    // Graph g;
    boost::unordered::unordered_map<std::pair<std::pair<int ,int>, std::vector<std::pair<int, int>>>, std::pair<std::pair<std::pair<int, int>, std::pair<int, int>>, std::pair<int, int>>> foreign_food;
    ...
    PacmanGraph(std::vector<std::pair<int, int>> food_list, std::pair<int, int> start_node, std::vector<std::pair<int, int>> component, boost::unordered::unordered_map<std::pair<std::pair<int ,int>, std::vector<std::pair<int, int>>>, std::pair<std::pair<std::pair<int, int>, std::pair<int, int>>, std::pair<int, int>>> foreign_food_map, boost::unordered::unordered_map<std::pair<int, int>, bool> articulation_points, boost::unordered::unordered_map<std::pair<std::pair<int, int>, std::pair<int, int>>, int> pm);
    int num_nodes() const;
    // const std::vector<std::vector<int>> &matrix();
    const std::pair<int, int> get_pac_start();
    const std::vector<std::pair<int, int>> get_food();
    ...
    boost::unordered::unordered_map<std::pair<std::pair<int ,int>, std::vector<std::pair<int, int>>>, std::pair<std::pair<std::pair<int, int>, std::pair<int, int>>, std::pair<int, int>>>* get_foreign_food_map();
